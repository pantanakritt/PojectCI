		...
		echo "</tr>";
			...
			foreach ($userstat as $stat_query) {
				...
				if($stat_query['StatusID']){
					...
					echo "<td>";
					echo "<div align='center'>";
					echo "<a href='#' class='activateID'><img src='tools/img/disac2.gif' height='80%' width='80%'>";
					...
					echo "</td>";
					echo "<td><center>".$stat_query['UserFirstname']."</center></td><td><center>".$stat_query['UserLastname']."</center></td><td>";
						if($stat_query['Gender']){echo "<center>Male</center>";}else {echo "<center>Female</center>";}
						echo "</td><td><div align='center'>";
						echo "<a href='#' class='activateID'><img src='tools/img/activ.gif' height='80%' width='80%'>";
						echo "<input type='hidden' class='statname' value='".$stat_query['UserName']."'>";
						echo "<input type='hidden' class='statid' value='".$stat_query['StatusID']."'>";
					echo "</a>";
